...
export default function Barbers() {
  const barbers = [
    { 
      name: 'OUSSAMA', 
      specialty: 'Coupes Homme & Dégradés Précis', 
      experience: 'Expert', 
      image: '/said_work.png', 
      rating: 5 
    },
    { 
      name: 'SAID', 
      specialty: 'Barbe & Coupes Modernes', 
      experience: 'Expert', 
      image: '/said_oussama.jpg', 
      rating: 5 
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
            {barbers.map((barber, index) => (
              <div key={index} className="group">
                ...
                <div className="relative h-96 md:h-[420px] mb-6 overflow-hidden rounded-xl shadow-md hover:shadow-lg transition-shadow">
                  <img
                    src={barber.image}
                    alt={barber.name}
